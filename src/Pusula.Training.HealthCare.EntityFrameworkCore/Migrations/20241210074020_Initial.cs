    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppInsurances", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityNumber = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    ...
                    MobilePhoneNumberCode = table.Column<string>(type: "text", nullable: false),
                    MobilePhoneNumber = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    HomePhoneNumberCode = table.Column<string>(type: "text", nullable: true),
                    HomePhoneNumber = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    EndTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestProcesses_AppDoctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AppDoctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestProcesses_AppPatients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AppPatients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestProcesses_Tests_TestId",
                        column: x => x.TestId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkLists_AppDoctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AppDoctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkLists_AppPatients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AppPatients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkLists_Tests_TestId",
                        column: x => x.TestId,
                        principalTable: "Tests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPatients_No_FirstName_LastName_IdentityNumber_PassportNu~",
                table: "AppPatients",
                columns: new[] { "No", "FirstName", "LastName", "IdentityNumber", "PassportNumber" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestProcesses_DoctorId",
                table: "TestProcesses",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_TestProcesses_PatientId",
                table: "TestProcesses",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_TestProcesses_TestId",
                table: "TestProcesses",
                column: "TestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkLists_DoctorId",
                table: "WorkLists",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkLists_PatientId",
                table: "WorkLists",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkLists_TestId",
                table: "WorkLists",
                column: "TestId");
        }
