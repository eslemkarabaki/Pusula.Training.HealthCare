...
namespace Pusula.Training.HealthCare.Migrations
{
    ...
    [Migration("20241221231944_PatientHistoryModuleTablesAdded")]
    partial class PatientHistoryModuleTablesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Allergies.Allergy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.BloodTransfusions.BloodTransfusion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppBloodTransfusions", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Educations.Education", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Examinations.ExaminationAnamnez", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.ExaminationsPhysical.ExaminationPhysical", b =>
                {
                    ...
                    b.Property<string>("PhysicalNote")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Jobs.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Medicines.Medicine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Operations.Operation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppOperations", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistories.PatientHistory", b =>
                {
                    ...
                    b.Property<int[]>("SpecialCases")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.Property<int[]>("Therapies")
                        .IsRequired()
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryAllergies.PatientHistoryAllergy", b =>
                {
                    ...
                    b.Property<bool>("NotExist")
                        .HasColumnType("boolean");

                    b.HasKey("AllergyId", "PatientHistoryId");

                    b.ToTable("AppPatientHistoryAllergies", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryBloodTransfusions.PatientHistoryBloodTransfusion", b =>
                {
                    ...
                    b.HasKey("BloodTransfusionId", "PatientHistoryId");

                    b.ToTable("AppPatientHistoryBloodTransfusions", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryMedicines.PatientHistoryMedicine", b =>
                {
                    ...
                    b.ToTable("AppPatientHistoryMedicines", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryOperations.PatientHistoryOperation", b =>
                {
                    ...
                    b.HasKey("OperationId", "PatientHistoryId");

                    b.ToTable("AppPatientHistoryOperations", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryVaccines.PatientHistoryVaccine", b =>
                {
                    ...
                    b.HasKey("VaccineId", "PatientHistoryId");

                    b.ToTable("AppPatientHistoryVaccines", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Protocols.Protocol", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProtocolNo"));
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Vaccines.Vaccine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppVaccines", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistories.PatientHistory", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Educations.Education", "Education")
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.PatientHistories.PatientHistory", "EducationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Pusula.Training.HealthCare.Jobs.Job", "Job")
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.PatientHistories.PatientHistory", "JobId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryAllergies.PatientHistoryAllergy", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Allergies.Allergy", null)
                        .WithMany("Allergies")
                        .HasForeignKey("AllergyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Pusula.Training.HealthCare.PatientHistories.PatientHistory", null)
                        .WithMany("Allergies")
                        .HasForeignKey("AllergyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryBloodTransfusions.PatientHistoryBloodTransfusion", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.BloodTransfusions.BloodTransfusion", null)
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryMedicines.PatientHistoryMedicine", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Medicines.Medicine", null)
                        .WithMany("Medicines")
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryOperations.PatientHistoryOperation", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Operations.Operation", null)
                        .WithMany("Operations")
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PatientHistoryVaccines.PatientHistoryVaccine", b =>
                {
                    ...
                    b.HasOne("Pusula.Training.HealthCare.Vaccines.Vaccine", null)
                        .WithMany("Vaccines")
                        .HasForeignKey("VaccineId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.RadiologyExaminationDocuments.RadiologyExaminationDocument", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.RadioloyRequestItems.RadiologyRequestItem", null)
                        .WithMany()
