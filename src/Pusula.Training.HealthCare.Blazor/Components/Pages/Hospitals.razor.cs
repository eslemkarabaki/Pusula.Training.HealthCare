...
namespace Pusula.Training.HealthCare.Blazor.Components.Pages
{
    public partial class Hospitals
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            Toolbar.AddButton(L["NewHospital"], OpenCreateHospitalModalAsync, IconName.Add, requiredPolicyName: HealthCarePermissions.Hospitals.Create);
        ...
        private async Task DownloadAsExcelAsync()
        {
            ...
            NavigationManager.NavigateTo($"{remoteService?.BaseUrl.EnsureEndsWith('/') ?? string.Empty}api/app/hospitals/as-excel-file?DownloadToken={token}&FilterText={HttpUtility.UrlEncode(Filter.FilterText)}{culture}&Name={HttpUtility.UrlEncode(Filter.Name)}", forceLoad: true);
        }
        ...
        private async Task CloseEditHospitalModalAsync()
        {
            await EditHospitalModal.Hide();
        }
        ...
        {
            var message = AllHospitalsSelected ? L["DeleteAllRecords"] : L["DeleteSelectedRecords", SelectedHospitals.Count].Value;
