...
namespace Pusula.Training.HealthCare.Blazor.Components.Pages.PatientRegistrations.Definitions.Insurances
{
    public partial class Insurance
    {
        ...
        {
            EditingInsurance = ObjectMapper.Map<InsuranceDto, InsuranceUpdateDto>(await InsurancesAppService.GetAsync(input.Id));
