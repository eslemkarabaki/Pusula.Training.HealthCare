...
public interface IProtocolTypeAppService : IApplicationService
{
    ...
    Task<PagedResultDto<ProtocolTypeWithNavigationPropertiesDto>> GetListWithNavigationPropertiesAsync(
    ...
    Task<ProtocolTypeWithNavigationPropertiesDto> GetWithNavigationPropertiesAsync(Guid id);
